            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse text-center ">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="index.html" class="hvr-wobble-bottom">
                                <p><img src="assets/img/menu/6.png" alt="Home" title="Home">

                                    <br class="hidden-xs">Conteudo<br class="hidden-xs"> Digital</p>
                            </a>
                        </li>
                        <li class="visible-xs"><a href="index.html" class="hvr-wobble-bottom">
                                <p>SOU CLIENTE CIATOS!</p>
                            </a>
                        </li>
                        <li class="visible-xs"><a href="index.html" class="hvr-wobble-bottom">
                                <p>CONTATO</p>
